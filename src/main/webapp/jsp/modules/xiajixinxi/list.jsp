...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">下机信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>下机信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">下机信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shangjishijianSearch" class="form-control form-control-sm" placeholder="请输入上机时间" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xiajibianhao')">下机编号<i id="xiajibianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('xiajishijian')">下机时间<i id="xiajishijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#shangjishijianSearch').val() != null && $('#shangjishijianSearch').val() != ''){
				searchForm.shangjishijian ="%" +  $('#shangjishijianSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xiajixinxi/page","GET",{
				...
				shangjishijian : searchForm.shangjishijian,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var xiajibianhaoCell  = document.createElement('td');

						 xiajibianhaoCell.innerHTML = item.xiajibianhao;

			row.appendChild(xiajibianhaoCell);
			...
			var xiajishijianCell  = document.createElement('td');

						  xiajishijianCell.innerHTML = item.xiajishijian;


			row.appendChild(xiajishijianCell);
		...
		function sh(){
			...
			httpJson("xiajixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiajixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xiajixinxi");
