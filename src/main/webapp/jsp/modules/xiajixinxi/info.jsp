						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="xiajibianhao" name="xiajibianhao" class="form-control" v-model="ruleForm.xiajibianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>用户账号</label>
									...
									<input id="shangjishijian" name="shangjishijian" class="form-control" v-model="ruleForm.shangjishijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>机号</label>
									...
									<input id="xiajishijian" name="xiajishijian" class="form-control" v-model="ruleForm.xiajishijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>时间</label>
