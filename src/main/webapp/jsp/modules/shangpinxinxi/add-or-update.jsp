...
<body>
									...
									<div class="form-group col-md-6">
										...
										<input name="shuliang" id="shuliang" name="shuliang" class="form-control" placeholder="数量">
											...
											<div class="form-group  col-md-12" >
												<label>商品简述</label>
												<div><div class="upload"><input id="shangpinjianshuupload" name="file" type="file">选择文件</div>
												<script id="shangpinjianshuEditor" type="text/plain"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var shangpinjianshuUe = UE.getEditor('shangpinjianshuEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" name="shangpinjianshu" id="shangpinjianshu-input">
												</div>
											</div>	
	...
	<script>
		...
		// 文件上传
		function upload(){
			$('#shangpinjianshuupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {	
					UE.getEditor('shangpinjianshuEditor').execCommand('insertHtml','<img src=\"'+ baseUrl +'upload/'+ data.result.file + '\" width=900 height=560>');					
				}
			});
		}  
		//取消 
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.shangpinjianshu != null && ruleForm.shangpinjianshu != 'null' && ruleForm.shangpinjianshu != ''){
				var shangpinjianshuMes = '' + ruleForm.shangpinjianshu;
				var shangpinjianshuUeditor = UE.getEditor('shangpinjianshuEditor');
				shangpinjianshuUeditor.ready(function() {
					shangpinjianshuUeditor.setContent(shangpinjianshuMes);
				});
			}
		}  
		...
		// 获取富文本框内容
		function getContent(){
			if(UE.getEditor('shangpinjianshuEditor').hasContents()){
				$('#shangpinjianshu-input').attr('value',UE.getEditor('shangpinjianshuEditor').getContent());
			}
		}
		...
		function dataBind(){
			...
			$("#shangpinjianshu").val(ruleForm.shangpinjianshu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangpinjianshu != null && res.data.shangpinjianshu != ''){

						$("#shangpinjianshu").val(res.data.shangpinjianshu);
                        var shangpinjianshuMes = '' + res.data.shangpinjianshu;
                        var shangpinjianshuUeditor = UE.getEditor('shangpinjianshuEditor');
                        shangpinjianshuUeditor.ready(function() {
                            shangpinjianshuUeditor.setContent(shangpinjianshuMes);
                        });
