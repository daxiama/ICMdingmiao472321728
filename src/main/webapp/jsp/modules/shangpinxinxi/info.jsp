							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group  col-md-12">
										<label>商品简述</label>
										<script id="shangpinjianshuEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.shangpinjianshu != null && ruleForm.shangpinjianshu != 'null' && ruleForm.shangpinjianshu != ''){
				var mes = '' + ruleForm.shangpinjianshu;
				var shangpinjianshuUeditor = UE.getEditor('shangpinjianshuEditor');
				shangpinjianshuUeditor.ready(function() {
					shangpinjianshuUeditor.setContent(mes);
					shangpinjianshuUeditor.setDisabled('fullscreen');
				});
			}
		}  
